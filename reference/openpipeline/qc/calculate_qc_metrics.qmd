...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/v4.2.0/src/qc/calculate_qc_metrics/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
