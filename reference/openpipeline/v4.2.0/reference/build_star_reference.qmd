...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/v4.2.0/src/reference/build_star_reference/config.vsh.yml){.btn-action .btn-sm .btn-info .btn role="button"}
