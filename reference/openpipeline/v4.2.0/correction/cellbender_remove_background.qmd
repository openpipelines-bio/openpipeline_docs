...
[{{< fa brands github >}} View source code](https://github.com/openpipelines-bio/openpipeline/tree/v4.2.0/src/correction/cellbender_remove_background)

[![](/images/viash-hub-logo.svg){.vh-icon} Browse all versions](https://www.viash-hub.com/packages/openpipeline)

[![](/images/viash-hub-logo.svg){.vh-icon} Get run instructions](https://www.viash-hub.com/packages/openpipeline/v4.2.0/components/correction/cellbender_remove_background)
...
|`--output_raw`                    |Output directory to store the raw CellBender output bundle alongside the .h5mu output.                                |`file`, required, example: `"cellbender_output"`           |
...
|`--obs_droplet_efficiency`        |Name of the column in the .obs dataframe to store the droplet efficiencies in.                                        |`string`, default: `"cellbender_droplet_efficiency"`       |
...
Generate a `params.yaml` for this component on [Viash Hub](https://www.viash-hub.com/packages/openpipeline/v4.2.0/components/correction/cellbender_remove_background).
