...
[{{< fa brands github >}} View source code](https://github.com/openpipelines-bio/openpipeline/tree/v4.2.0/src/annotate/celltypist)

[![](/images/viash-hub-logo.svg){.vh-icon} Browse all versions](https://www.viash-hub.com/packages/openpipeline)

[![](/images/viash-hub-logo.svg){.vh-icon} Get run instructions](https://www.viash-hub.com/packages/openpipeline/v4.2.0/components/annotate/celltypist)
...
Generate a `params.yaml` for this component on [Viash Hub](https://www.viash-hub.com/packages/openpipeline/v4.2.0/components/annotate/celltypist).
...
|`--input_layer`                  |The layer in the input data containing counts that are lognormalized to 10000, .X is not to be used.                                       |`string`, default: `"log_normalized"`     |
...
|`--reference_layer`          |The layer in the reference data containing counts that are lognormalized to 10000, if .X is not to be used.                                    |`string`                                   |
