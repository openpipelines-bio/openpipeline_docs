...
[{{< fa brands github >}} View source code](https://github.com/openpipelines-bio/openpipeline/tree/v4.2.0/src/feature_annotation/highly_variable_features_scanpy)

[![](/images/viash-hub-logo.svg){.vh-icon} Browse all versions](https://www.viash-hub.com/packages/openpipeline)

[![](/images/viash-hub-logo.svg){.vh-icon} Get run instructions](https://www.viash-hub.com/packages/openpipeline/v4.2.0/components/feature_annotation/highly_variable_features_scanpy)
...
Generate a `params.yaml` for this component on [Viash Hub](https://www.viash-hub.com/packages/openpipeline/v4.2.0/components/feature_annotation/highly_variable_features_scanpy).
...
|`--features_to_exclude` |User-defined list of feature names to exclude before HVG calculation.  These features will be excluded from HVG selection but will remain in the output data.                                                                                                                                                                                                                                                                                                                                        |List of `string`, example: `"MT-CO1", "MT-CO2", "MT-ND1"`, multiple_sep: `";"` |
