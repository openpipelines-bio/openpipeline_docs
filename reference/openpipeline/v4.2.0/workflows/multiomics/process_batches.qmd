...
```{mermaid}
flowchart TB
    c_dimensionality_reduction["dimensionality_reduction"]
    c_intersect_obs["intersect_obs"]
    c_merge[\merge/]
    c_prot_multisample["prot_multisample"]
    c_rna_multisample["rna_multisample"]
    c_split_modalities[/split_modalities\]
    c_intersect_obs --> c_dimensionality_reduction
    c_merge --> c_intersect_obs
    c_prot_multisample --> c_merge
    c_rna_multisample --> c_merge
    c_split_modalities --> c_merge
    c_split_modalities --> c_prot_multisample
    c_split_modalities --> c_rna_multisample
    style c_dimensionality_reduction fill:#f2f6f3,stroke:#8ba295,stroke-dasharray:5 3,color:#566b5f
    style c_intersect_obs fill:#f2f6f3,stroke:#8ba295,stroke-dasharray:5 3,color:#566b5f
    style c_merge fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_prot_multisample fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_rna_multisample fill:#e2f4e7,stroke:#2b8f52,color:#13201a
