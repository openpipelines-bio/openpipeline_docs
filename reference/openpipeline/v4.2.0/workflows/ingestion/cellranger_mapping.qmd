...
```{mermaid}
flowchart TB
    c_convert_from_10xh5_to_h5mu["from_10xh5_to_h5mu"]
    c_mapping_cellranger_count["cellranger_count"]
    c_mapping_cellranger_count_split[/cellranger_count_split\]
    c_mapping_cellranger_count --> c_mapping_cellranger_count_split
    c_mapping_cellranger_count_split --> c_convert_from_10xh5_to_h5mu
    style c_convert_from_10xh5_to_h5mu fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_mapping_cellranger_count fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_mapping_cellranger_count_split fill:#e2f4e7,stroke:#2b8f52,color:#13201a
```
