...
```{mermaid}
flowchart TB
    c_demux_bcl2fastq["bcl2fastq"]
    c_demux_bcl_convert["bcl_convert"]
    c_demux_cellranger_mkfastq["cellranger_mkfastq"]
    style c_demux_bcl2fastq fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_demux_bcl_convert fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_demux_cellranger_mkfastq fill:#e2f4e7,stroke:#2b8f52,color:#13201a
```
