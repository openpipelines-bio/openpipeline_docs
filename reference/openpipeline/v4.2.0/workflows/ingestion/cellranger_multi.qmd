...
### Links
[Source](https://github.com/openpipelines-bio/openpipeline/blob/v4.2.0/src/workflows/ingestion/cellranger_multi/config.vsh.yaml){.btn-action .btn-sm .btn-info .btn role="button"}
...
|`--output_h5mu` |Locations for the output files. Must contain a wildcard (*) character, which will be replaced with the sample name. |`file`, required, example: `"*.h5mu"`     |
