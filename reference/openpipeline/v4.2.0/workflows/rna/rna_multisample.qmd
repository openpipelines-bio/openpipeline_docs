...
```{mermaid}
flowchart TB
    c_highly_variable_features_scanpy["highly_variable_features_scanpy"]
    c_log_normalize["log_normalize"]
    c_qc["qc"]
    c_scale["scale"]
    c_highly_variable_features_scanpy --> c_qc
    c_log_normalize --> c_scale
    c_scale --> c_highly_variable_features_scanpy
    style c_highly_variable_features_scanpy fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_log_normalize fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_qc fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_scale fill:#f2f6f3,stroke:#8ba295,stroke-dasharray:5 3,color:#566b5f
```
