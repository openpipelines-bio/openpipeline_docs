...
```{mermaid}
flowchart TB
    c_align_query_reference["align_query_reference"]
    c_concatenate_h5mu[\concatenate_h5mu/]
    c_delete_layer["delete_layer"]
    ...
    c_align_query_reference --> c_split_modalities
    c_concatenate_h5mu --> c_highly_variable_features_scanpy
    c_delete_layer --> c_scvi_leiden
    c_delete_layer --> c_split_h5mu
    c_highly_variable_features_scanpy --> c_delete_layer
    c_knn --> c_merge
    c_scvi_leiden --> c_delete_layer
    c_split_h5mu --> c_knn
    c_split_modalities --> c_concatenate_h5mu
    c_split_modalities --> c_merge
    style c_align_query_reference fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_concatenate_h5mu fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_delete_layer fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_highly_variable_features_scanpy fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_knn fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_merge fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    style c_scvi_leiden fill:#e2f4e7,stroke:#2b8f52,color:#13201a
