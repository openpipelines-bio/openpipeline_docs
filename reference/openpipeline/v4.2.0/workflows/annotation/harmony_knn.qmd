...
flowchart TB
    ...
    c_delete_layer --> c_harmony_leiden
    c_harmony_leiden --> c_split_h5mu
    c_highly_variable_features_scanpy --> c_pca
    c_knn --> c_merge
    c_pca --> c_delete_layer
    c_split_h5mu --> c_knn
    ...
    style c_harmony_leiden fill:#e2f4e7,stroke:#2b8f52,color:#13201a
    ...
    style c_pca fill:#e2f4e7,stroke:#2b8f52,color:#13201a
